...
public class WaitUtility {
    ...
    public enum LocatorType{
        Id,Xpath,ClassName,CssSelector,LinkText,TagName,Name
    }
    ...
    public void waitVisibilityOfElementLocatorBy(WebDriver driver,Enum locatorType,String target){
        ...
        if(locatorType.equals(LocatorType.Id)){
            ...
            try {
                throw new Exception("Invalid Locator name");
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
